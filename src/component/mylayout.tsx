...
export default function MyLayout(props: { children: any }) {
    ...
    return (
        <>
            ...
            <nav className="block fixed top-0 left-0 z-30 w-full bg-white border-b border-gray-200 dark:bg-gray-800 dark:border-gray-700">
                <div className="px-5 py-10 lg:px-5 lg:pl-3">
                    <div className="flex items-center justify-between">
                        <div className="flex items-center justify-start">
                            <button onClick={() => setShowSideBar(!showSideBar)} data-drawer-target="logo-sidebar" data-drawer-toggle="logo-sidebar" aria-controls="logo-sidebar" type="button" className="inline-flex items-center p-2 text-sm text-gray-500 rounded-lg sm:hidden hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200 dark:text-gray-400 dark:hover:bg-gray-700 dark:focus:ring-gray-600">
                                ...
                                <svg className="w-full h-24 lg:w-6 lg:h-6" aria-hidden="true" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                                    <path clipRule="evenodd" fillRule="evenodd" d="M2 4.75A.75.75 0 012.75 4h14.5a.75.75 0 010 1.5H2.75A.75.75 0 012 4.75zm0 10.5a.75.75 0 01.75-.75h7.5a.75.75 0 010 1.5h-7.5a.75.75 0 01-.75-.75zM2 10a.75.75 0 01.75-.75h14.5a.75.75 0 010 1.5H2.75A.75.75 0 012 10z"></path>
                                </svg>
                            </button>
                            <a href="https://flowbite.com" className="flex ml-2 lg:mr-24">
                                <img src="https://flowbite.com/docs/images/logo.svg" className="h-16 lg:h-8 mr-3" alt="FlowBite Logo" />
                                <span className="self-center text-7xl font-semibold sm:text-2xl whitespace-nowrap dark:text-white">Flowbite</span>
                            </a>
                        </div>
                        <div className="flex items-center">
                            <div className="flex items-center ml-3">
                                <button type="button" className="flex text-sm bg-gray-800 rounded-full focus:ring-4 focus:ring-gray-300 dark:focus:ring-gray-600" aria-expanded="false" data-dropdown-toggle="dropdown-user" onClick={() => { setShowAccount(!showAccount) }}>
                                    ...
                                    <img className="w-24 h-24 lg:w-10 lg:h-10 rounded-full" src={userData.user.pathuserpicture != null ? import.meta.env.VITE_SERVER_URL + "/" + userData.user.pathuserpicture : "https://flowbite.com/docs/images/people/profile-picture-5.jpg"} alt="user photo" />
                                </button>
            ...
            <div className="block w-full  px-4 py-5 ">
                {props.children}
            </div>

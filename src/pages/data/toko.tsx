...
export default function Toko() {
    ...
    return (<>
        <MyLayout>
                    ...
                    <table className="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                        ...
                        <tbody>
                            <tr className="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                                ...
                                <td className="px-6 py-4">nama toko</td>
                            </tr>
            ...
            <div id="authentication-modal" tabIndex={-1} className={`${showModalAdd ? "hidden" : ""} fixed top-0 left-0 right-0 z-50  w-full p-4 overflow-x-hidden overflow-y-auto md:inset-0 h-[calc(100%-1rem)] max-h-full`}>
